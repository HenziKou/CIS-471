...
def depthFirstSearch(problem):
    ...
    # Push start location and action to fringe
    fringe.push((start, []))

   # Traverse to next state in fringe while fringe is not empty
    while not fringe.isEmpty():
        # Pop the next location tuple and action
    ...
    return action + [direction] # Return action list and most recent direction
...
def breadthFirstSearch(problem):
    ...
    #Initialize a fringe using queue properties to store states
    fringe = util.Queue()
